...
namespace eval ::optrace {
  variable script "/home/graham/Documents/LCD_SPI_controller_16_bit/LCD_SPI_controller_16_bit.runs/impl_1/LCD_SPI_controller_16_bit.tcl"
...
OPTRACE "link_design" START { }
  link_design -top LCD_SPI_controller_16_bit -part xc7a35tcpg236-1
...
OPTRACE "route_design reports" START { REPORT }
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -check_timing_verbose -max_paths 10 -file LCD_SPI_controller_16_bit_timing_summary_routed.rpt -pb LCD_SPI_controller_16_bit_timing_summary_routed.pb -rpx LCD_SPI_controller_16_bit_timing_summary_routed.rpx -warn_on_violation "
...
if {$rc} {
  write_checkpoint -force LCD_SPI_controller_16_bit_routed_error.dcp
...
OPTRACE "read constraints: write_bitstream" END { }
  catch { write_mem_info -force LCD_SPI_controller_16_bit.mmi }
...
OPTRACE "read constraints: write_bitstream_post" END { }
  catch {write_debug_probes -quiet -force LCD_SPI_controller_16_bit}
  catch {file copy -force LCD_SPI_controller_16_bit.ltx debug_nets.ltx}
